<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="商品ID" prop="orderSn"/>
      ...
      <el-table-column
        :filters="[{ text: '未回复', value: false}, { text: '已回复', value: true }]"
        :filter-method="filterLevel"
        align="center"
        label="回复"
        prop="response">
        <template slot-scope="scope">
          <el-tag :type="scope.row.isReply === true ? true : false ">{{ scope.row.response}}</el-tag>
        </template>
      </el-table-column>
      <!-- <el-table-column align="center" label="回复" prop="response"/> -->
  ...
  methods: {
    getList() {
      ...
      listComment(this.listQuery)
        .then(response => {
          this.list = response.data.data.commentList;
