<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="物流单号" width="200">
        <template slot-scope="scope">
          <el-button @click="handleToS(scope.row)" type="primary" size="mini" >{{ scope.row.shipSn }}</el-button>
        </template>
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleToS(row) {
      this.$router.push({ path: "/mall/orderSelect", query: { expNo: row.shipSn} });
    },
    confirmShip() {
